...
class VirtualSD:
    ...
    def get_file_list(self, check_subdirs=False, path=""):
        ...
        if check_subdirs:
            ...
            logging.info("sdcard_dirname:" + self.sdcard_dirname)
            ...
            try:
                ...
                return [
                    ...
                    if not fname.startswith(".") and os.path.isfile((os.path.join(dname, fname)))
                ]
            except:
    ...
    cmd_SDCARD_SELECT_FILE_help = "Select a SD file.  May " "include files in subdirectories."
